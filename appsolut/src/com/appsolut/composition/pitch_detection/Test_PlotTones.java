...
//	}
//	@Test
//	public void testSubsequentFrequencies500hz200hz(){
//		String filename;
//		int[] exOut = new int[1];
//		int[] acOut = new int[1];
//		int numChannels;
...
//		
//		for(int i=0;i<50;i++){
//			filename = "src/test-tones/500hz.wav";
//			exOut[0] = 500;
//			try{
//				WavFile wavFile = WavFile.openWavFile(new File(filename));
//				numChannels = wavFile.getNumChannels();
//				sampleSize = 8820;
//				inputWaveform = new double[sampleSize*numChannels];
//				wavFile.readFrames(inputWaveform,sampleSize);
//				inputWaveform = PlotTones.getBinArray(inputWaveform,inputWaveform.length/numChannels);
//				sampleRate= wavFile.getSampleRate();
//				noiseFreqs = new double[inputWaveform.length];
//				acOut = PlotTones.getProminentFrequencies(inputWaveform, sampleRate, 1, noiseFreqs);
//			}catch(Exception e){
//				System.err.println(e);
//			}
//			assertArrayClose(exOut,acOut,5.0);
//			
//			filename = "src/test-tones/200hz.wav";
//			exOut[0] = 200;
//			try{
//				WavFile wavFile = WavFile.openWavFile(new File(filename));
//				numChannels = wavFile.getNumChannels();
...
////------------------------------------------------------------------------------------------------------------------------
//
//	private int[] wavFileToAllPitches(String filename, double numSecs,int windowSize, int slideRate){
//		try{
//		WavFile wavFile = WavFile.openWavFile(new File(filename));
//		int numChannels = wavFile.getNumChannels();
//		long sampleRate= wavFile.getSampleRate();
...
//		double[] inputWaveform = new double[sampleSize];
//		wavFile.readFrames(inputWaveform, 2*sampleSize);
...
//		String filename = "src/test-tones/50hz.wav";
//		int[] acOut = this.wavFileToAllPitches(filename,0.5,8192,8192);
//		int[] exOut = new int[acOut.length];
//		for(int i=0; i<exOut.length; i++){
//			exOut[i] = 50;
//		}
//		assertArrayClose(exOut,acOut,10);
//	}
//	@Test
//	public void testAudioToAllFreqs500hz(){
//		String filename = "src/test-tones/500hz.wav";
//		int[] acOut = this.wavFileToAllPitches(filename,0.5,4000,4000);
//		int[] exOut = new int[acOut.length];
//		for(int i=0; i<exOut.length; i++){
//			exOut[i] = 500;
//		}
//		assertArrayClose(exOut,acOut,13);
//	}
//	@Test
//	public void testAudioToAllFreqs500hzBig(){
//		String filename = "src/test-tones/500hz.wav";
//		int[] acOut = this.wavFileToAllPitches(filename,0.5,44100,44100);
//		int[] exOut = new int[acOut.length];
//		for(int i=0; i<exOut.length; i++){
//			exOut[i] = 500;
//		}
...
////		int[] windowSizes = {8192,4096,2048,1024};
////		int[] slides = {8192,4096,2048,1024,512,256,128};
////		int[] vals;
////		int max =0;
////		int sum=0;
////		double ave =0;
...
////			for(int s: slides){
////				if(s<=w){
////					vals = this.wavFileToAllPitches(filename,0.5,w,s);
////					max = 0;
////					sum=0;
////					for(int v:vals){
////						if(Math.abs(v-500)>max){
////							max = Math.abs(v-500);
////						}
////						sum+=Math.abs(v-500);
////					}
...
////					System.out.print("Max Difference: ");
////					System.out.println(max);
////					System.out.print("Ave Difference: ");
